...
const styles = {
  ...
  tab:         { flex: 1, padding: '10px 0', borderTop: 'none', borderLeft: 'none', borderRight: 'none', borderBottom: '2px solid transparent', background: 'none', cursor: 'pointer', fontSize: 14, color: '#888' },
  tabActive:   { color: '#ff6b35', fontWeight: 700, borderTop: 'none', borderLeft: 'none', borderRight: 'none', borderBottom: '2px solid #ff6b35', marginBottom: -2 },
  ...
  btn:         { marginTop: 8, padding: 12, background: '#ff6b35', color: '#fff', border: 'none', borderRadius: 8, fontSize: 15, cursor: 'pointer' },
  ...
  resultEmail: { fontSize: 20, fontWeight: 700, color: '#ff6b35', marginBottom: 24 },
  linkBtn:     { display: 'inline-block', padding: '10px 28px', background: '#ff6b35', color: '#fff', borderRadius: 8, fontSize: 14, textDecoration: 'none' },
